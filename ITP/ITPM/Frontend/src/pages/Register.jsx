...
export function Register({ onRegister, onNavigateToLogin }) {
            ...
            <p className="text-xs text-red-500 mt-1.5 ml-1">
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="student@university.edu" className={`w-full pl-11 pr-4 py-3 bg-wellness-bg/50 border ${errors.email ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-wellness-border focus:border-wellness-blue focus:ring-wellness-blue/10'} rounded-xl focus:bg-white focus:ring-4 outline-none transition-all text-sm`}/>
