...
export function App() {
  ...
  if (!isAuthenticated) {
    if (authPage === 'login') {
      return <Login onLogin={handleLoginSuccess} onNavigateToRegister={() => setAuthPage('register')} />;
    }

    return <Register onRegister={handleRegisterSuccess} onNavigateToLogin={() => setAuthPage('login')} />;
  }
